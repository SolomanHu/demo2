...
<form action="<c:url value='/QuestionServlet'/>" method="post">
	...
	<input type="hidden" name="qid" value="${ques.q_id}" />
<table border="0" align="center" width="40%" style="margin-left: 100px;">
	
	<tr>
		<td>分数</td>
		<td>
			<input type="text" name="score" value="${ques.score}"/>
		</td>
		<td>
	...
	<tr>
		<td>题目内容</td>
		<td>
				<input type="text" name="description" value="${ques.description}"/>
		</td>
		<td>
	...
	<tr>
		<td>选项A</td>
		<td>
			<input type="text" name="chooseA" value="${ques.chooseA}"/>
		</td>
		<td>
	...
	<tr>
		<td>选项B</td>
		<td>
			<input type="text" name="chooseB" value="${ques.chooseB}"/>
		</td>
		<td>
	...
	<tr>
		<td>选项C</td>
		<td>
			<input type="text" name="chooseC" value="${ques.chooseC}"/>
		</td>
		<td>
	...
	<tr>
		<td>选项D</td>
		<td>
			<input type="text" name="chooseD" value="${ques.chooseD}"/>
		</td>
		<td>
	...
	<tr>
		<td>正确答案</td>
		<td>
			<input type="text" name="answer" value="${ques.answer}"/>
		</td>
		<td>
	...
	<tr>
		<td>&nbsp;</td>
		<td>
			<input type="button" value="编辑题目" onclick="add()"/>
